...
plot(datapc.sub.mutate$Global_active_power~datapc.sub.mutate$datetimestamp, type="l", xlab="", ylab="Global Active Power", cex=0.2)

plot(datapc.sub.mutate$Voltage~datapc.sub.mutate$datetimestamp, type="l", xlab="datetime", ylab="Voltage")
...
plot(datapc.sub.mutate$Global_reactive_power~datapc.sub.mutate$datetimestamp, type="l", xlab="datetime", ylab="Global_reactive_power")
